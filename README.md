...
**--nf** The initial number of factors that the algorithm should start with, SFAmix will shrink this number to the true number (assume such a number can be found) <br/>
